...
(function () { return __awaiter(_this, void 0, void 0, function () {
    var spinner, _a, mode, profile, region, key, secret, userpool, directory, file, password, passwordModulePath, cognitoISP, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                _a = _b.sent(), mode = _a.mode, profile = _a.profile, region = _a.region, key = _a.key, secret = _a.secret, userpool = _a.userpool, directory = _a.directory, file = _a.file, password = _a.password, passwordModulePath = _a.passwordModulePath;
                ...
                return [4 /*yield*/, index_1.backupUsers(cognitoISP, userpool, directory)];
            case 3:
                _b.sent();
