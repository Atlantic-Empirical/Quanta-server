...
exports.argv = yargs
    ...
    // help
    .help('help', dimmed(templateObject_16 || (templateObject_16 = __makeTemplateObject(["Show help"], ["Show help"]))))
    .alias('help', 'h')
    .showHelpOnFail(false, bold(templateObject_17 || (templateObject_17 = __makeTemplateObject(["Specify --help for available options"], ["Specify --help for available options"]))))
    // version
    .version('version', dimmed(templateObject_18 || (templateObject_18 = __makeTemplateObject(["Show version number"], ["Show version number"]))), (function () { return version; })())
    .alias('version', 'v')
    // footer
    .epilog(dimmed(templateObject_19 || (templateObject_19 = __makeTemplateObject(["\nPlease report any issues/suggestions here:\nhttps://github.com/rahulpsd18/cognito-backup-restore/issues\n"], ["\\nPlease report any issues/suggestions here:\\nhttps://github.com/rahulpsd18/cognito-backup-restore/issues\\n"]))))
    .strict()
