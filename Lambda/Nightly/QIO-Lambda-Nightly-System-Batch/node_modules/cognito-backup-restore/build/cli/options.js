...
var credentials = new AWS.IniLoader().loadFrom({});
var savedAWSProfiles = Object.keys(credentials);
var searchAWSProfile = function (_, input) { return __awaiter(_this, void 0, void 0, function () {
    var fuzzyResult;
    return __generator(this, function (_a) {
        input = input || '';
        fuzzyResult = fuzzy.filter(input, savedAWSProfiles);
        return [2 /*return*/, fuzzyResult.map(function (el) {
                return el.original;
            })];
    });
}); };
var searchCognitoRegion = function (_, input) { return __awaiter(_this, void 0, void 0, function () {
...
var verifyOptions = function () { return __awaiter(_this, void 0, void 0, function () {
    var mode, profile, region, key, secret, userpool, directory, file, password, passwordModulePath, modeChoice, awsProfileChoice, awsRegionChoice, cognitoISP, UserPools, userPoolList_1, searchCognitoPool, cognitoPoolChoice, directoryLocation, fileLocation, pwdModule;
    var _this = this;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                mode = args_1.argv.mode, profile = args_1.argv.profile, region = args_1.argv.region, key = args_1.argv.key, secret = args_1.argv.secret, userpool = args_1.argv.userpool, directory = args_1.argv.directory, file = args_1.argv.file, password = args_1.argv.password, passwordModulePath = args_1.argv.passwordModulePath;
            ...
            case 1:
                ...
                _a.label = 2;
            case 2:
                if (!(!savedAWSProfiles.includes(profile) && (!key || !secret))) return [3 /*break*/, 4];
                return [4 /*yield*/, inquirer.prompt({
                        type: 'autocomplete',
                        name: 'selected',
            ...
            case 7:
                ...
                searchCognitoPool = function (_, input) { return __awaiter(_this, void 0, void 0, function () {
                    var fuzzyResult;
                    return __generator(this, function (_a) {
                        input = input || '';
            ...
            case 9:
                ;
                if (!(mode === 'backup' && !directory)) return [3 /*break*/, 11];
                return [4 /*yield*/, inquirer.prompt({
                        type: 'directory',
                        name: 'selected',
            ...
            case 11:
                ;
                if (!(mode === 'restore' && !file)) return [3 /*break*/, 13];
                return [4 /*yield*/, inquirer.prompt({
                        type: 'filePath',
                        name: 'selected',
            ...
            case 13:
                ...
                return [2 /*return*/, { mode: mode, profile: profile, region: region, key: key, secret: secret, userpool: userpool, directory: directory, file: file, password: password, passwordModulePath: passwordModulePath }];
        }
    });
}); };
